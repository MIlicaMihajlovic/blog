<?php include 'db.php' //konekcija za sql?>
 ...
 foreach ($posts as $post) {
   ?>     
        ...
        <div class='blog-post'>
                ...
                <h2 class= ''><a href='single-post.php?id='<?php echo($post['id']) ?>><?php echo($post['title']) ?></a></h1>
                <p class= ''><?php echo ($post['created_at']) ?> by <a> <?php echo ($post['author']) ?> </a><p>
